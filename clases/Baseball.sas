...
/*Data cooking*/
proc freq data=baseball; run;

/* normalidad */
proc univariate data=baseball normal plot;
 var salary;
 qqplot salary / NORMAL (MU=EST SIGMA=EST COLOR=RED L=1);
...
proc univariate data=baseball normal plot;
 var logSalary;
 qqplot logSalary / NORMAL (MU=EST SIGMA=EST COLOR=RED L=1);
 HISTOGRAM /NORMAL(COLOR=MAROON W=4) CFILL = BLUE CFRAME = LIGR;
 INSET MEAN STD /CFILL=BLANK FORMAT=5.2;
run;
...
%let ruta1 = '/home/doloreslorente0/my_content/data_output/macro01.txt';
...
proc glmselect data=baseball plots=all seed=&semilla;
  partition fraction(validate=0.4);
  class league division; 
  model logSalary = nAtBat nHits nHome nRuns nRBI nBB yrMajor crAtBat crHits                             
                    crHome crRuns crRbi crBB league division nOuts nAssts nError 
...
%let ruta2 = '/home/doloreslorente0/my_content/data_output/macro02.txt';
...
proc glmselect data=baseball plots=all seed=&semilla;
  ...
  model logSalary = nAtBat nHits nHome nRuns nRBI nBB yrMajor crAtBat crHits
                   crHome crRuns crRbi crBB league division nOuts nAssts nError  
division*nhits division*nbb division*yrmajor division*crruns division*crhits division*crbb division*nouts
...
%let ruta3 = '/home/doloreslorente0/my_content/data_output/macro03.txt';
...
%let ruta4 = '/home/doloreslorente0/my_content/data_output/macro04.txt';
...
/*Vamos a ver cu�ntas veces sale como mejor modelo cada uno de ellos*/
data seleccion;
length modelo $90;
input modelo $ 1-76 ase frac semilla;
cards;
Intercept nHits YrMajor CrRuns                                                 0.377268       12355
Intercept nHits nBB YrMajor                                                    0.345976       12356
Intercept nHits YrMajor CrHits                                                 0.362558       12357
Intercept nHits CrRuns                                                         0.349652       12358
Intercept nHits nBB YrMajor CrHits                                             0.394289       12359
Intercept nHits YrMajor CrRuns nOuts                                           0.384031       12360
Intercept nHits YrMajor CrRuns                                                 0.296842       12361
Intercept nHits nBB YrMajor CrHits Division                                    0.302547       12362
Intercept nHits nBB YrMajor CrRuns                                             0.317173       12363
Intercept nHits nBB YrMajor League Division nOuts nError                       0.353734       12364
Intercept nAtBat nHits nBB YrMajor CrRbi Division nOuts                        0.316338       12365
Intercept nHits nBB nOuts YrMajor*Division CrHits*Division                     0.371135       12355
Intercept nHits YrMajor CrHits*Division                                        0.338870       12356
Intercept nHits CrHits*Division                                                0.351648       12357
Intercept nHits CrHits*Division                                                0.345955       12358
Intercept nHits nBB YrMajor CrHits                                             0.394289       12359
Intercept YrMajor CrRuns nHits*Division                                        0.373318       12360
Intercept nHits nBB YrMajor nOuts nError CrHits*Division                       0.317138       12361
Intercept nHits YrMajor*Division CrHits*Division                               0.324836       12362
Intercept nHits nBB YrMajor CrRuns*Division                                    0.316853       12363
Intercept nRuns nBB YrMajor CrRuns CrHits*Division                             0.380068       12364
Intercept nHits nBB YrMajor nOuts CrHits*Division                              0.311185       12365
Intercept nRuns nBB CrBB YrMajor*Division CrHits*Division                      0.352608  0.3  12355
Intercept nBB YrMajor nAssts nHits*Division                                    0.361363  0.3  12356
Intercept nAtBat nHits nBB YrMajor League CrHits*Division                      0.411075  0.3  12357
Intercept nHits CrBB nBB*Division YrMajor*Division CrHits*Division             0.357060  0.3  12358
Intercept nAtBat nHits nBB YrMajor CrHits*Division                             0.412003  0.3  12359
Intercept nAtBat nHits nBB YrMajor League nOuts CrHits*Division                0.500061  0.3  12360
Intercept nBB nAssts nHits*Division YrMajor*Division                           0.367659  0.3  12361
Intercept nHits nBB YrMajor CrBB CrHits*Division                               0.271579  0.3  12362
Intercept nHits nBB YrMajor nOuts CrHits*Division                              0.362860  0.3  12363
Intercept nHits nBB YrMajor League CrHits*Division CrBB*Division               0.307524  0.3  12364
Intercept nAtBat nHits nHome nBB YrMajor CrBB CrHits*Division                  0.422285  0.3  12365
Intercept nHits nBB YrMajor CrBB CrHits*Division                               0.366959  0.4  12355
Intercept nHits nBB YrMajor nOuts nError CrRuns*Division                       0.331377  0.4  12356
Intercept nAtBat nHits nBB CrHits CrRuns                                       0.431347  0.4  12357
Intercept nHits nBB YrMajor CrBB nOuts CrHits*Division                         0.389467  0.4  12358
Intercept nHits nBB YrMajor CrAtBat League nOuts nError nHits*Division nBB*Divi0.359778aj0.4Di12359n CrBB*Division
Intercept nBB YrMajor League nError nHits*Division nOuts*Division              0.383900  0.4  12360
Intercept nHits YrMajor CrAtBat nOuts CrHits*Division                          0.391966  0.4  12361
Intercept nHits nBB CrBB YrMajor*Division CrHits*Division nOuts*Division       0.364387  0.4  12362
Intercept nHits nBB League YrMajor*Division CrHits*Division                    0.370796  0.4  12363
Intercept nHits nBB CrBB League YrMajor*Division CrHits*Division               0.392207  0.4  12364
Intercept nAtBat nOuts nError YrMajor*Division CrHits*Division                 0.346010  0.4  12365
Intercept nHits CrHits*Division                                                0.354972  0.5  12355
Intercept nHits YrMajor CrHits                                                 0.390763  0.5  12356
Intercept nHits nHome nBB YrMajor CrBB nOuts CrHits*Division                   0.401583  0.5  12357
Intercept nHits nBB CrBB nError YrMajor*Division CrHits*Division               0.345338  0.5  12358
Intercept nBB YrMajor nHits*Division                                           0.347445  0.5  12359
Intercept nHits nHome YrMajor CrHits*Division                                  0.315016  0.5  12360
Intercept nBB YrMajor CrBB CrHits*Division                                     0.371876  0.5  12361
Intercept nHits nBB YrMajor nError CrHits*Division nOuts*Division              0.413167  0.5  12362
Intercept nHits nBB YrMajor CrRuns*Division                                    0.362893  0.5  12363
Intercept nAtBat nHits nBB CrBB nOuts YrMajor*Division CrHits*Division         0.419945  0.5  12364
Intercept nAtBat nHits nBB YrMajor nOuts nError                                0.393383  0.5  12365
Intercept nHits YrMajor*Division CrHits*Division                               0.365810  0.3  12355
Intercept nHits nBB YrMajor CrHits*Division                                    0.384206  0.3  12356
Intercept nHits nBB YrMajor CrHits*Division                                    0.344826  0.3  12357
Intercept nHits CrHits*Division                                                0.374197  0.3  12358
Intercept nRuns YrMajor*Division CrHits*Division                               0.344116  0.3  12359
Intercept nBB YrMajor nHits*Division CrRuns*Division                           0.368407  0.3  12360
Intercept nHits YrMajor*Division CrHits*Division                               0.330470  0.3  12361
Intercept nHits YrMajor*Division CrHits*Division                               0.294659  0.3  12362
Intercept nHits nBB YrMajor CrRuns*Division                                    0.328660  0.3  12363
Intercept nHits nBB YrMajor CrRuns*Division CrHits*Division                    0.343646  0.3  12364
Intercept nHits nBB YrMajor CrHits*Division                                    0.265292  0.3  12365
Intercept nHits nBB nOuts YrMajor*Division CrHits*Division                     0.371135  0.4  12355
Intercept nHits YrMajor CrHits*Division                                        0.338870  0.4  12356
Intercept nHits CrHits*Division                                                0.351648  0.4  12357
Intercept nHits CrHits*Division                                                0.345955  0.4  12358
Intercept nHits nBB YrMajor CrHits                                             0.394289  0.4  12359
Intercept YrMajor CrRuns nHits*Division                                        0.373318  0.4  12360
Intercept nHits nBB YrMajor nOuts nError CrHits*Division                       0.317138  0.4  12361
Intercept nHits YrMajor*Division CrHits*Division                               0.324836  0.4  12362
Intercept nHits nBB YrMajor CrRuns*Division                                    0.316853  0.4  12363
Intercept nRuns nBB YrMajor CrRuns CrHits*Division                             0.380068  0.4  12364
Intercept nHits nBB YrMajor nOuts CrHits*Division                              0.311185  0.4  12365
Intercept nHits nBB CrBB League YrMajor*Division CrRuns*Division               0.347580  0.5  12355
Intercept nHits YrMajor CrHome                                                 0.396537  0.5  12356
Intercept nHits YrMajor CrHits*Division                                        0.333794  0.5  12357
Intercept nHits CrHits*Division                                                0.348408  0.5  12358
Intercept nAtBat nHits nBB YrMajor CrHits                                      0.380978  0.5  12359
Intercept YrMajor nOuts nError nHits*Division                                  0.354431  0.5  12360
Intercept nHits YrMajor CrHits*Division                                        0.335607  0.5  12361
Intercept nHits YrMajor*Division CrHits*Division                               0.391516  0.5  12362
Intercept nRBI nBB YrMajor CrBB CrRuns*Division                                0.365819  0.5  12363
Intercept nHits nBB YrMajor CrBB CrHits*Division                               0.315671  0.5  12364
Intercept nHits CrHits*Division                                                0.316629  0.5  12365
;
...
proc glmselect data=baseball plots=all;
  class league division; 
  model logSalary = nHits crHits*division	/ selection=none details=all  stats=all;
run;   
...
proc glmselect data=baseball plots=all;
  class league division; 
  model logSalary = nHits yrMajor*division crHits*division	/ selection=none details=all stats=all;
run;  
...
proc glm data=baseball;
  class league division;
  model logSalary  = nHits yrMajor*division crHits*division / solution e;
run;
